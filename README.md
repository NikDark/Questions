...
[Что такое mutable и immutable типы данных? Какие типы данных могут быть ключом в словаре?](#mutable&immutable)
___
...
___
:white_check_mark:
### А сейчас просто интересный случай
#### Что напечатает?
```py
def foo(x,a[]):
    a.append(x)
...
:white_check_mark:
### Какая разница между range() и xrange()
